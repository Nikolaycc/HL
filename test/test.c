...
Res Route(Req r) {
    return (Res){200, HL_Format("<h1>where are im?: </h1>")};
}
...
int main(void) {
    ...
    // HL_Router_New(&rou);                            //
    //                                                 //
    // HL_Router_Put(&rou, "/router1", 12);            //
    // HL_Router_Put(&rou, "/router2", 20);            //
    // HL_Router_Put(&rou, "/router3", 31);            //
    // HL_Router_Put(&rou, "/router4", 70);            //
    //                                                 //
    // int a = HL_Router_Get(&rou, "/router1").result; //
    // int b = HL_Router_Get(&rou, "/router2").result; //
    // int c = HL_Router_Get(&rou, "/router3").result; //
    // int d = HL_Router_Get(&rou, "/router4").result; //
    //                                                 //
    // printf("%d %d %d %d\n", a, b, c, d);            //
    /////////////////////////////////////////////////////
